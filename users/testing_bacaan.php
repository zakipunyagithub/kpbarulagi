    ...
    <section class="hero-section">
		...
		<div class="container">
			<h3 class="text-center"> Silakan Membaca Berbagai Bacaan Kami </h3>
			<br>
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									<img style="width: 550px; height: 400px;" src="../assets/foto_produk/<?php echo $pecah['foto_produk'];?>" alt="">
								...
								<div class="pi-text">
									...
									<a href="single-product.php?&id=<?php echo $pecah['id_produk']; ?>" class="btn btn-success">
