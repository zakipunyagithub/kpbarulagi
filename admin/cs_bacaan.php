                    ...
                    <tbody>
                        ...
                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="badge badge-danger" href="cs_edit_bacaan.php?id=<?php echo $pecah['id_bacaan']; ?>">edit
                                    </a>
                                    <a class="badge badge-warning" onclick="return confirm('Apakah Anda yakin ingin menghapus ini ?')" href="cs_hapus_bacaan.php?id=<?php echo $pecah['id_bacaan']; ?>">hapus</a>
                                </td>
                            </tr>
                            <?php $nomor++; ?>
                        <?php } ?>
...
if (isset($_POST['save'])) {
    ...
    if (mysqli_query($koneksi, $query)) {
        echo "<meta http-equiv='refresh' content='1;url=cs_bacaan.php'>";
    } else {
        echo "<meta http-equiv='refresh' content='1;url=cs_bacaan.php'>";
    }
}
