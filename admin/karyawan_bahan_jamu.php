                    ...
                    <tbody>
                        ...
                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                            <tr>
                                <td><?= $nomor; ?></td>
                                <td>
                                    <img src="../assets/bahan_jamu/<?php echo $pecah['foto'] ?>" width="200" height="200">
                                </td>
                                <td><?= $pecah['isi']; ?></td>
                                <td>
                                ...
                                <td>
                                    <a class="badge badge-danger" href="karyawan_edit_bahan_jamu.php?id=<?php echo $pecah['id']; ?>">edit
                                    </a>
